...
abstract class ExtendedSearch
{
     ...
     */
    abstract protected function simpleSearchQuery(string $query): QueryBuilder;
     ...
     *
     * @return QueryBuilder|null Search query or `null` on failure
     */
    public function generateSearchQuery(string $query): ?QueryBuilder
    {
    ...
    protected function parseQuery(string $query): ?QueryBuilder
    {
        $this->params = [];
        $this->errors = [];
