...
/**
 * Form for selecting storage location for assets.
 *
 * @author Ben Brooksnieder
 */
class StorageType extends AbstractType implements DataTransformerInterface
{
    ...
    public function reverseTransform($data): ?Asset
    {
        ...
        ->where($repository->isStorageQuery('a'))
